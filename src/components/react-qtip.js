...
/**
 *  QTooltip(react-qtip2) is react-based implementation of qtip2(http://qtip2.com)
 */
class QTooltip extends Component {
  static propTypes = {
    ...
    showTarget: PropTypes.oneOfType([PropTypes.bool, PropTypes.node]),
    ...
    showEffect: PropTypes.oneOfType([PropTypes.bool, PropTypes.func]),
    ...
    /** jQuery([]), false (Default: false) - Defaults to target element */
    hideTarget: PropTypes.oneOfType([PropTypes.bool, PropTypes.func]),
    /** "String", false (Default: "mouseleave") - Hide on mouse out by default */
    hideEvent: PropTypes.oneOfType([PropTypes.bool, PropTypes.string]),
    /** Function, true, false (Default: true) - Use default 90ms fade effect */
    hideEffect: PropTypes.oneOfType([PropTypes.bool, PropTypes.func]),
    ...
    hideInactive: PropTypes.oneOfType([PropTypes.number, PropTypes.bool]),
    ...
    hideDistance: PropTypes.oneOfType([PropTypes.number, PropTypes.bool]),
    ...
    tipCorner: PropTypes.oneOfType([PropTypes.string, PropTypes.bool]),
    /** "Corner", false (Default: false) - Don't mimic a particular corner */
    tipMimic: PropTypes.oneOfType([PropTypes.string, PropTypes.bool]),
    ...
    tipBorder: PropTypes.oneOfType([PropTypes.number, PropTypes.bool]),
